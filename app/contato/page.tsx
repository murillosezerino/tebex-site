    ...
    <main style={{ background: 'var(--black)', minHeight: '100vh' }}>
      ...
      <section style={{ minHeight: 'auto', padding: 'clamp(3rem, 6vw, 6rem) 1.5rem', display: 'block' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
          ...
          {/* Telefone */}
          <a href="tel:12997364365" style={{ textDecoration: 'none', padding: '2.5rem 2rem', border: '1px solid rgba(255,255,255,0.08)', transition: 'border-color 0.3s' }}
          ...
          >
            ...
            <p style={{ color: 'var(--white)', fontSize: '1.25rem', fontWeight: 200, letterSpacing: '-0.02em' }}>
              (12) 99736-4365
            </p>
            <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.75rem', fontWeight: 300, marginTop: '0.75rem' }}>
              Central disponível 24h por dia, 7 dias por semana.
            </p>
          </a>

          {/* WhatsApp */}
          <a href="https://wa.me/5512997364365?text=Ol%C3%A1%2C%20gostaria%20de%20falar%20com%20a%20Tebex%20Log" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', padding: '2.5rem 2rem', border: '1px solid rgba(255,255,255,0.08)', transition: 'border-color 0.3s' }}
            className="contato-card"
          >
            <p style={{ fontSize: '0.65rem', fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--gray)', marginBottom: '1rem' }}>
              WhatsApp
            ...
            <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.75rem', fontWeight: 300, marginTop: '0.75rem' }}>
              Resposta em minutos. Atendimento humanizado.
            </p>
          </a>

          {/* E-mail */}
          <a href="mailto:juliana.soares@tebexlog.com.br" style={{ textDecoration: 'none', padding: '2.5rem 2rem', border: '1px solid rgba(255,255,255,0.08)', transition: 'border-color 0.3s' }}
            className="contato-card"
          >
            <p style={{ fontSize: '0.65rem', fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--gray)', marginBottom: '1rem' }}>
              E-mail
            </p>
            <p style={{ color: 'var(--white)', fontSize: 'clamp(0.9rem, 1.5vw, 1.25rem)', fontWeight: 200, letterSpacing: '-0.02em' }}>
              juliana.soares@tebexlog.com.br
            </p>
            <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.75rem', fontWeight: 300, marginTop: '0.75rem' }}>
              Para cotações, parcerias e informações comerciais.
            </p>
          </a>
        </div>
      </section>
