  ...
  return (
    <>
      <style>{`
        ...
        /* Big background logo — proportional, contained inside the footer */
        .tbx-footer-bg-logo {
          position: absolute;
          left: 50%;
          top: 50%;
        ...
        @media (max-width: 900px) {
          ...
          .tbx-footer-bg-logo { width: 130%; opacity: 0.07; }
        }
        @media (max-width: 540px) {
          ...
          .tbx-footer-bg-logo { width: 170%; opacity: 0.06; }
        }
        ...
        <div className="tbx-footer-top">
          ...
          <div className="tbx-footer-col tbx-footer-brand-card">
            <Link href="/" aria-label="Tebex Log — início" className="tbx-footer-logo">
              <Logo height="clamp(68px, 9vw, 100px)" />
            </Link>
